...
graph TB
    %% 캐릭터 노드
    gatssn["👑 갓쓴키로형<br/>전략 설계자"]
    chonggak["👻 총각귀신형<br/>몰입 장인"]
    cheonyeo["👰 처녀귀신형<br/>UX 수호자"]
    dokkaebi["👹 도깨비형<br/>실험 개척자"]
    gumiho["🦊 구미호형<br/>자동화 마법사"]
    haetae["🦁 해태형<br/>품질 파수꾼"]
    jangseung["🪵 장승형<br/>거버넌스 수문장"]
    jeoseung["⚰️ 저승사자형<br/>부채 청산자"]
    mulgwisin["🌊 물귀신형<br/>연결 촉진자"]
    dalgyal["🥚 달걀귀신형<br/>추상화 장인"]
