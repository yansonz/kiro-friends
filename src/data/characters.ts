...
export const characters: CharacterProfile[] = [
  ...
  },
  {
    ...
    title: {
      ko: '성장 조력자',
      en: 'Growth Facilitator',
      ja: '成長助力者',
    },
    description: {
      ko: '팀의 성장을 돕는 따뜻한 멘토',
      en: 'Warm mentor who helps team growth',
      ja: 'チームの成長を助ける温かいメンター',
    },
    axisValues: { A: 1, B: 1, C: 1, D: -1 },
    primaryTag: '멘토링',
    strengths: {
      ko: [
        '후배 개발자를 인내심 있게 가르친다',
        '복잡한 개념을 쉽게 설명하는 능력이 있다',
        '팀의 성장과 발전에 기여한다',
      ],
      en: [
        'Patiently teaches junior developers',
        'Has ability to explain complex concepts easily',
        'Contributes to team growth and development',
      ],
      ja: [
        '後輩開発者を忍耐強く教える',
        '複雑な概念を簡単に説明する能力がある',
    ...
    pitfalls: {
      ko: [
        '다른 사람 돕느라 본인 업무가 밀릴 수 있다',
        '모든 질문에 답하려다 집중력이 분산될 수 있다',
        '가르치는 것에 빠져 자신의 성장을 소홀히 할 수 있다',
      ],
      en: [
        'Own tasks may pile up while helping others',
        'Focus may scatter trying to answer all questions',
        'May neglect own growth while absorbed in teaching',
      ],
      ja: [
        '他人を助けるのに自分の業務が遅れる可能性がある',
        'すべての質問に答えようとして集中力が分散される可能性がある',
        '教えることにハマって自分の成長を疎かにする可能性がある',
      ],
    },
    kiroFeatures: [
      {
        name: { ko: 'Specs', en: 'Specs', ja: 'Specs' },
        description: {
          ko: '학습 자료와 가이드를 체계적으로 문서화',
          en: 'Systematically document learning materials and guides',
          ja: '学習資料とガイドを体系的に文書化',
        },
        level: 'basic',
      },
      {
        name: { ko: 'Steering Rules', en: 'Steering Rules', ja: 'Steering Rules' },
        description: {
          ko: '팀 베스트 프랙티스를 Steering으로 공유',
          en: 'Share team best practices via Steering',
          ja: 'チームベストプラクティスをSteeringで共有',
        },
        level: 'basic',
      },
      {
        name: { ko: 'Skills', en: 'Skills', ja: 'Skills' },
        description: {
          ko: '반복 설명하는 개념을 Skill로 패키징하여 재사용',
          en: 'Package repeatedly explained concepts as Skills for reuse',
          ja: '反復説明する概念をSkillでパッケージ化して再利用',
        },
        level: 'basic',
      },
      {
        name: { ko: 'Autopilot Mode', en: 'Autopilot Mode', ja: 'Autopilot Mode' },
        description: {
          ko: '예제 코드 자동 생성으로 설명 시간 단축',
          en: 'Reduce explanation time with auto-generated example code',
          ja: '例示コード自動生成で説明時間短縮',
        },
        level: 'basic',
      },
      {
        name: { ko: 'Hooks (agentStop)', en: 'Hooks (agentStop)', ja: 'Hooks (agentStop)' },
        description: {
          ko: '작업 완료 시 자동으로 학습 문서 업데이트',
          en: 'Auto-update learning docs on task completion',
          ja: '作業完了時に自動で学習ドキュメント更新',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Custom Subagents', en: 'Custom Subagents', ja: 'Custom Subagents' },
        description: {
          ko: '온보딩 전문 에이전트를 분리하여 신규 멤버 교육 자동화',
          en: 'Automate new member training by separating onboarding specialist agents',
          ja: 'オンボーディング専門エージェントを分離して新規メンバー教育を自動化',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Multimodal Chat', en: 'Multimodal Chat', ja: 'Multimodal Chat' },
        description: {
          ko: '다이어그램과 스크린샷으로 시각적 설명 강화',
          en: 'Enhance visual explanations with diagrams and screenshots',
          ja: 'ダイアグラムとスクリーンショットで視覚的説明を強化',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Steering (fileMatch)', en: 'Steering (fileMatch)', ja: 'Steering (fileMatch)' },
        description: {
          ko: '특정 파일 패턴에 맞는 학습 가이드 자동 제공',
          en: 'Auto-provide learning guides matching specific file patterns',
          ja: '特定ファイルパターンに合う学習ガイド自動提供',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Powers (Notion, Confluence)', en: 'Powers (Notion, Confluence)', ja: 'Powers (Notion, Confluence)' },
        description: {
          ko: '문서 도구 Powers로 학습 자료를 팀 위키에 자동 동기화',
          en: 'Auto-sync learning materials to team wiki with documentation tool Powers',
          ja: 'ドキュメントツールPowersで学習資料をチームWikiに自動同期',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Powers (Strands + Bedrock)', en: 'Powers (Strands + Bedrock)', ja: 'Powers (Strands + Bedrock)' },
        description: {
          ko: 'Strands로 멘토링 에이전트 구축, Bedrock Claude가 개인별 학습 수준에 맞춘 설명 자동 생성',
          en: 'Build mentoring agents with Strands, Bedrock Claude auto-generates explanations tailored to individual learning levels',
          ja: 'Strandsでメンタリングエージェント構築、Bedrock Claudeが個人別学習レベルに合わせた説明を自動生成',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Skills (Teaching Patterns)', en: 'Skills (Teaching Patterns)', ja: 'Skills (Teaching Patterns)' },
        description: {
          ko: '초급/중급/고급별 교육 패턴 Skills를 멘토링 시에만 활성화하여 효과적 지식 전달',
          en: 'Activate beginner/intermediate/advanced teaching pattern Skills only during mentoring for effective knowledge transfer',
          ja: '初級/中級/上級別教育パターンSkillsをメンタリング時のみ有効化して効果的知識伝達',
        },
        level: 'advanced',
      },
      {
        name: { ko: 'Open Weight Models (All)', en: 'Open Weight Models (All)', ja: 'Open Weight Models (All)' },
        description: {
          ko: '다양한 모델로 설명 스타일을 바꿔가며 학습자 이해도 최적화',
          en: 'Optimize learner comprehension by varying explanation styles with different models',
          ja: '様々なモデルで説明スタイルを変えながら学習者理解度を最適化',
        },
        level: 'advanced',
      },
    ],
    aiTips: {
      ko: [
        '"이 개념을 초보자도 이해할 수 있게 설명해줘"',
        '"이 코드의 동작 원리를 단계별로 설명해줘"',
        '"이 에러 메시지가 왜 발생했는지 쉽게 설명해줘"',
      ],
      en: [
        '"Explain this concept so beginners can understand"',
        '"Explain how this code works step by step"',
        '"Explain why this error message occurred in simple terms"',
      ],
      ja: [
        '"この概念を初心者でも理解できるように説明して"',
        '"このコードの動作原理を段階的に説明して"',
        '"このエラーメッセージがなぜ発生したのか簡単に説明して"',
      ],
    },
    synergy: 'jangseung',
    tension: 'mulgwisin',
